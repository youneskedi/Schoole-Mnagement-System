                            ...
                            <div class="row mt-4">
                                @foreach($courses as $course)
                                    <div class="col-sm-4 mb-3" style="background-color: rgba(0,0,0,.03);">
                                        ...
                                        <span style="padding: 3px; margin-left: 80px" class="bg-info  mb-1  rounded"><a href="{{route('teacher.session.show' , $course)}}">Go To Course</a></span>
                                        ...
                                        <div class="container mt-4 mb-4">
                                            <div class="d-flex">
                                                <a href="{{route('teacher.course.addStu' , $course)}}" class="btn btn-primary mr-3 ml-3">Add Students</a>
                                                <a href="{{route('teacher.course.edit' , $course)}}" class="btn btn-secondary mr-3">Edit Students</a>
                                                <br>
                                            </div>
                                        </div>
                                    </div>
