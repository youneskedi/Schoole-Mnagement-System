        ...
        <div class="card-body">
            <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                    ...
                    <th class="text-center">{{__('Number of Finished Students')}}</th>
                    ...
                    <tr>
                        ...
                        @php
                            ...
                            if($certif == null)
                                ...
                                $users = $certif->users()->wherePivot('is_finished' , true)->get();
                            foreach ($users as $user)
                                {
                                    $count++ ;
                                }
                        ...
                        <td class="text-center pt-3">{{$count}} </td>
                        <td class="text-center">
                            <a href="{{route('certif.show' , $course)}}" class="btn btn-primary p-1">Certificates</a>
                        </td>
                    </tr>
                @endforeach
