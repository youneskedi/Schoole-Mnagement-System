                        ...
                        <div class="card-body">
                            <div class="row mt-4">
                               @foreach($courses as $course)
                                    <div class="col-sm-4 mb-3" style="background-color: rgba(241, 241, 14, 0.897); text-color:white">
                                       ...
                                       <h3 style="display: inline-block" class="m-2">{{$course->title}}</h3>
                                        <span style="padding: 3px; margin-left: 20px" class="btn btn-outline-danger mb-1  rounded  "><a   href="{{route('session.index' , $course)}}">Go To Course</a></span>
                                        ...
                                        @foreach($users as $user)
                                            ...
                                            @endphp
                                        @endforeach
                                        <h5 style="display: inline-block" class="ml-2  .text-warning-emphasis">number of students : </h5> <span>{{$count}}</span>
                                        <div class="container mt-4 mb-4">
                                            <div class="d-flex">
                                                <a href="{{route('course.show' , $course)}}" class="btn btn-primary mr-3 ml-3">Add Student</a>
                                                <a href="{{route('course.edit' , $course)}}" class="btn btn-success mr-3">Edit Course</a>
                                                <br>
                                            </div>
                                            <div>
