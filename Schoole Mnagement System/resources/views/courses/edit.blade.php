...
@section('content')
    <div class="container mt-5">
        <form action="{{ route('course.update', $course) }}" method="post" enctype="multipart/form-data">
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="bg-light p-3">
                        <h2 class="mb-3">Manage Teacher List</h2>
                        <table class="table table-bordered">
                            <thead>
                            <tr>
                                <th>Name</th>
                            ...
                            @foreach($teachers as $teacher)
                                <tr>
                                    ...
                                    <td>
                                        <div id="checklist">
                                            <input value="{{$teacher->id}}" name="checkTech[]" type="checkbox" id="{{ $teacher->id }}"
                                                   @if(in_array($teacher->id, $selectedTeacherIds)) checked @endif>
                                            <label for="{{ $teacher->id }}">Add Teacher</label>
                                        </div>
                                    </td>
                                </tr>
                            @endforeach
            ...
            <div class="row">
                <div class="col-md-6">
                    <button type="submit" class="btn btn-primary ml-4 mb-4">Update Course</button>
                </div>
            </div>
        </form>
    </div>
